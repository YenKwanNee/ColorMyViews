...
class MainActivity : AppCompatActivity() {
    ...
    private fun setListeners() {
        ...
        val redButton: TextView = findViewById(R.id.red_button)
        val greenButton : TextView = findViewById(R.id.green_button)
        val yellowButton : TextView = findViewById(R.id.yellow_button)
